...
export default function EvaluationSection() {
    ...
    return (
        <div className="px-2 sm:px-12 lg:px-12 mt-15 md:mt-20">
            <div className="relative rounded-[32px] overflow-hidden">
                ...
                {/* Content grid */}
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center p-3 sm:p-12 lg:p-16">
